  ...
  extension ViewController: CBCentralManagerDelegate {
      ...
      func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral, advertisementData: [String : Any], rssi RSSI: NSNumber) {
        ...
        // connecting to the first device with the given characteristics, which should always be the bluefruit
        centralManager.stopScan()
        centralManager.connect(bluefruitPeripheral)
      }

      // MARK: - Connect
      func centralManager(_ central: CBCentralManager, didConnect peripheral: CBPeripheral) {
          stopScanning()
        // interates through all the available services
  ...
  extension ViewController: CBPeripheralDelegate {
      ...
      func peripheral(_ peripheral: CBPeripheral, didDiscoverServices error: Error?) {
        ...
        // first service because we are only interested in one
    ...
    func peripheral(_ peripheral: CBPeripheral, didDiscoverCharacteristicsFor service: CBService, error: Error?) {
      ...
      guard let characteristics = service.characteristics else {
        ...
        // iterating through each characteristic and checking to see if they are equal to the characteristics we specified
      for characteristic in characteristics {

        // setting the characteristic variables equal to the devices' characteristc if their UUID is equal to the ones we specified
        if characteristic.uuid.isEqual(CBUUIDs.BLE_Characteristic_uuid_Rx)  {

            // rx characteristic: the characteristic that we READ
        ...
        // tx characteristic: the characteristic that we WRITE
